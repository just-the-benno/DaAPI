...
{
    public class ChildScopeAddressPropertiesViewModel
    {
        ...
        [RebindTimeAdjustmentInParentRange(true, ErrorMessageResourceName = nameof(ValidationErrorMessages.RebindTimeAdjustmentInParentRange), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
        [Display(Name = nameof(DHCPv6ScopeDisplay.T1), ResourceType = typeof(DHCPv6ScopeDisplay))]
        public Double? T1 { get; set; }

        [Max(0.95, NullAreValid = true, ErrorMessageResourceName = nameof(ValidationErrorMessages.Max), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
        [Min(0.1, NullAreValid = true, ErrorMessageResourceName = nameof(ValidationErrorMessages.Min), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
        [RebindTimeAdjustmentInParentRange(false, ErrorMessageResourceName = nameof(ValidationErrorMessages.RebindTimeAdjustmentInParentRange), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
        ...
        [TimeSpanInParentRange(true, ErrorMessageResourceName = nameof(ValidationErrorMessages.TimeSpanInParentRange), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
        ...
        [TimeSpanInParentRange(false, ErrorMessageResourceName = nameof(ValidationErrorMessages.TimeSpanInParentRange), ErrorMessageResourceType = typeof(ValidationErrorMessages))]
