...
{
    public class RebindTimeAdjustmentInParentRangeAttribute : ValidationAttribute
    {
        private readonly Boolean _isT1;

        public RebindTimeAdjustmentInParentRangeAttribute(Boolean isT1) : base("is not in parent range")
        {
            _isT1 = isT1;
        }
